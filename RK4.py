...
w=Oscillator(numOsc=2, small=True,initial1=[0.1,0.0],initial2=[0.1,0.0,0.0,0.0],dHat=0.0,R=0.01,G=0.) # if dHat is non-zero the pendulum is damped.
w.RK4(step=0.01,end=100)
